...
ALTER TABLE ONLY cucb.auth_action_types
    ADD CONSTRAINT idx_17283_primary PRIMARY KEY (id);
...
ALTER TABLE ONLY cucb.auth_tokens
    ADD CONSTRAINT idx_17295_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.auth_user_types
...
ALTER TABLE ONLY cucb.biscuit_poll_entries
    ADD CONSTRAINT idx_17322_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.biscuit_poll_votes
    ADD CONSTRAINT idx_17329_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.captions
    ADD CONSTRAINT idx_17339_primary PRIMARY KEY (captionid);
ALTER TABLE ONLY cucb.committees
    ADD CONSTRAINT idx_17348_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.committee_keys
    ADD CONSTRAINT idx_17354_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.committee_members
    ADD CONSTRAINT idx_17360_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.committee_positions
    ADD CONSTRAINT idx_17371_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.connection_types
    ADD CONSTRAINT idx_17377_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.contacts
    ADD CONSTRAINT idx_17383_primary PRIMARY KEY (id);
...
ALTER TABLE ONLY cucb.gigs_contacts
    ADD CONSTRAINT idx_17412_primary PRIMARY KEY (gig_id, contact_id);
...
ALTER TABLE ONLY cucb.user_password_resets
    ADD CONSTRAINT idx_17538_primary PRIMARY KEY (id);
ALTER TABLE ONLY cucb.user_prefs
    ADD CONSTRAINT idx_17543_primary PRIMARY KEY (user_id, pref_id);
